...
<div class="justify-content-center">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body mx-10">
            <form method="post" action="/dashboard/lowongan" class="mb-5" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  @enderror
                   ...
                   <input id="detail_lowongan" type="hidden" name="detail_lowongan" value="{{ old('detail_lowongan') }}" required>
                ...
                <div class="mb-3">
                  ...
                  @enderror
                   ...
                   <input id="kriteria_lowongan" type="hidden" name="kriteria_lowongan" value="{{ old('kriteria_lowongan') }}" required>
                ...
                <div class="mb-3">
                  ...
                  @enderror
                   ...
                   <input id="informasi_tambahan" type="hidden" name="informasi_tambahan" value="{{ old('informasi_tambahan') }}">
