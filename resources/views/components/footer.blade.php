...
<div class="footer-2-2 container-fluid position-relative p-0" style="font-family: 'Poppins', sans-serif">
    <div class="list-footer">
        <div class="row gap-md-0 gap-3">
            <div class="col-lg-3 col-md-6">
                <div class="">
                    ...
                    <nav class="list-unstyled">
                        ...
                        <li class="list-space">
                            <a href="/lowongan" class="list-menu">Lowongan</a>
                        </li>
                        <li class="list-space">
                            <a href="/informasi" class="list-menu">Informasi</a>
                        </li>
                    </nav>
                </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6">
                <h2 class="footer-text-title">BKK SMK Muhammadiyah Kandanghaur</h2>
                <nav class="list-unstyled">

                    <li class="list-space">
                        <h6>Alamat</h6>
                        <small><i class="bi bi-geo-alt"></i> Jl. Raya Kandanghaur No.28 A, Karanganyar, Kec. Kandanghaur, <br> Kabupaten Indramayu, Jawa Barat 45254</small>
                    </li>
                    ...
                    <li class="list-space">
                        <h6>Email</h6>
                        <small><i class="bi bi-envelope"></i> bkk@email.com</small>
                    </li>
    ...
    <div class="border-color info-footer">
        ...
        <div class="mx-auto d-flex flex-column flex-lg-row align-items-center footer-info-space gap-4">
            <div class="d-flex title-font font-medium align-items-center gap-4">
                ...
                <a href="http://www.instagram.com/bmmiftah">
                ...
                <a href="http://www.dribbble.com/bmiftah">
                    <svg class="social-media-c" width="30" height="30" viewBox="0 0 30 30" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <circle cx="15" cy="15" r="15" fill="#C7C7C7" />
                        <g clip-path="url(#clip0)">
